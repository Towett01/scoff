    ...
    <section className="min-h-screen bg-gradient-to-br from-green-50 via-white to-red-50 flex items-center justify-center px-4 py-16">
      <div className="max-w-lg w-full">
        ...
        {!chosen ? (
          ...
          >
            <div className="mb-6">
              <span className="inline-block bg-green-600 text-white text-xs font-bold px-4 py-1 rounded-full uppercase tracking-widest mb-4">
                Refer &amp; Earn
              </span>
              <h1 className="text-4xl font-bold text-gray-900 mb-3">
                Earn <span className="text-green-600">KES 30</span> per referral!
              </h1>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl px-6 py-4 mb-8 text-left">
              <p className="text-sm text-yellow-800 font-semibold mb-1">How it works:</p>
              <p className="text-sm text-yellow-700">1. Choose how you want to refer below</p>
              <p className="text-sm text-yellow-700">2. Share your unique referral link</p>
              <p className="text-sm text-yellow-700">3. Friend makes a qualifying purchase</p>
              <p className="text-sm text-yellow-700 font-bold">4. You both earn KES 30 airtime! 🎉</p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 mb-8">
              <motion.button
                ...
                className="flex items-center gap-4 bg-green-600 text-white px-6 py-5 rounded-2xl shadow-lg hover:bg-green-700 transition"
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-green-100 text-sm">Use SSTOPUP Exchange app referral</p>
                </div>
              ...
              <motion.button
                ...
                className="flex items-center gap-4 bg-white border-2 border-green-600 text-green-700 px-6 py-5 rounded-2xl shadow-lg hover:bg-green-50 transition"
              >
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-500 text-sm">Use SSTOPUP Exchange website referral</p>
                </div>
                <span className="ml-auto text-2xl text-green-600">→</span>
              </motion.button>
            </div>
          ...
          >
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-6">
              ...
              <Link
                ...
                className="block bg-green-600 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-green-700 transition mb-4"
              >
            ...
            <p className="text-xs text-gray-400">
              ...
              <Link href="https://scofhub.com/refer-earn" className="underline text-green-600">
