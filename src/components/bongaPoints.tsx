  ...
  return (
    ...
    <section className="relative py-2 px-6 bg-gradient-to-r from-green-100 via-white to-red-100 overflow-hidden">
      <div className="max-w-6xl mx-auto text-center ">
        ...
        >
          We provide bongapoints services ......
        </motion.p>
      </div>
      <div className="flex justify-between max-w-xs mx-auto mt-8 mb-5">
        <button
          ...
          className="px-6 py-2 bg-white border disabled border-gray-300 text-gray-700 rounded-lg shadow-md hover:bg-gray-100 transition"
        >
          Previous
        </button>
        ...
        <button
          onClick={() => {
            window.location.href = "/calls-minutes";
          }}
